...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
		...
		m_blockExplorerButton->setVisible(false);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutIntensecoinAction->setText(QApplication::translate("MainWindow", "About Sikka", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND SIKKA", Q_NULLPTR));
