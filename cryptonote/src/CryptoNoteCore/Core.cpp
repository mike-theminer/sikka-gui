...
printf ("\n get block getDifficultyForNextBlock  \n");
...
std::error_code Core::addBlock(const CachedBlock& cachedBlock, RawBlock&& rawBlock) {
  ...
  if(previousBlockIndex %100 == 0)
	printf("\n previousBlockIndex %d currentDifficulty %ld\n",previousBlockIndex,currentDifficulty );
